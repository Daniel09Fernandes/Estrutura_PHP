...
abstract class CommonDBChild extends CommonDBConnexity {
  ...
  // Mapping between DB fields
   ...
   static public $log_history_unlock = Log::HISTORY_UNLOCK_SUBITEM;
    ...
    // Produção 
     public $servername = "10.99.10.9:3306";
     public $username = "glpiadm";
     public $password = "glpi2020#$";
     public $dbname = "glpidb";
  
  

   // homolog
   // public $servername = "10.0.101.62:8090";
   // public $username = "root";
   // public $password = "htn@glpi";
   // public $dbname = "glpidb";                                                    
   
   
      
    public $apiName =  "http://ua-appweb01:8080/DataSnap/rest/TSM/";  //"http://ua-dev01:8080/DataSnap/rest/TSM/"; 
